# Create a channel with Terraform
...
The resource itself that's being created is done with the `octopusdeploy_channel` Terraform resource. The values in the input blocks are:
