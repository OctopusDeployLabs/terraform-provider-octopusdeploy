...
func testAzureServicePrincipalAccountBasic(localName string, name string, description string, applicationID uuid.UUID, tenantID uuid.UUID, subscriptionID uuid.UUID, password string, tenantedDeploymentParticipation core.TenantedDeploymentMode) string {
