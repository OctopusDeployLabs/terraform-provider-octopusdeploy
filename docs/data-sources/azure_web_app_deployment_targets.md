...
- **azure_web_apps** (Block List) A list of Azure web app deployment targets that match the filter(s). (see [below for nested schema](#nestedblock--azure_web_apps))
- **id** (String, Read-only) A auto-generated identifier that includes the timestamp when this data source was last modified.

<a id="nestedblock--azure_web_apps"></a>
### Nested Schema for `azure_web_apps`
