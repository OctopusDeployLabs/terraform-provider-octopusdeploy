...
Start-ProcessAdvanced -FilePath 'go' -ArgumentList "test -v -timeout 30s ./octopusdeploy/..." -EnvironmentKeyValues @{ OCTOPUS_URL = $OCTOPUS_URL; OCTOPUS_APIKEY = $OCTOPUS_APIKEY } -Verbose
